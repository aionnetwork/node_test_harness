...
class StakingContractHelper {
    ...
    private RPC rpc;
    private PreminedAccount preminedAccount;
    private PrivateKey stakingContractOwner;

    private PrepackagedLogEventsFactory prepackagedLogEventsFactory;
    private LocalNodeListener listener;

    StakingContractHelper(
        PreminedAccount _pa,
        RPC _rpc,
        PrepackagedLogEventsFactory _plef,
        LocalNodeListener _listener) throws InvalidKeySpecException {
        preminedAccount = _pa;
        rpc = _rpc;
        prepackagedLogEventsFactory = _plef;
        listener = _listener;
        stakingContractOwner =
                PrivateKey.fromBytes(
                        ByteUtil.hexStringToBytes(
                                "0xcc76648ce8798bc18130bc9d637995e5c42a922ebeab78795fac58081b9cf9d4"));
    }

    TransactionReceipt deployStakingContractWithDefaultOwner() throws InterruptedException {
    ...
    TransactionReceipt deployStakingContract() throws InterruptedException {
        TransactionResult result = RawTransaction.buildAndSignAvmCreateTransaction(
    ...
    TransactionReceipt fundParticipant(Address participant) throws InterruptedException {
    ...
    TransactionReceipt sendCall(RawTransaction transaction) throws InterruptedException {
